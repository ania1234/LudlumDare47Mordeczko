...
public class OutputVolume : MonoBehaviour
{
    ...
    {
        PrefabBar, ObjectPosition, ObjectRotation, ObjectScale, Custom
    }
    ...
    private IEnumerator Start()
    {
        ...
        //TODO: further subscribe to this audio manager, i.e changing effects with volume.
    ...
    private void Update()
    {
        ...
        switch (outputType)
        {
            ...
            case OutputType.Custom:
                customAnalyzer.ProcessNewVolume(newValue);
                break;
        }
    }
